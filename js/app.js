...
const App = (() => {
  ...
  let checkTestData27  = null;
  let checkTestData28  = null;
  let checkTestData29  = null;
  let checkTestData30  = null;
  let checkTestData31  = null;
  let checkTestData32  = null;
  let checkTestData33  = null;
  let checkTestData34  = null;
  let checkTestData35  = null;
  let checkTestData36  = null;
  let checkTestData37  = null;
  let checkTestData38  = null;
  let checkTestData39  = null;
  let checkTestData40  = null;
  let checkTestData41  = null;
  let checkTestData42  = null;
  let checkTestData43  = null;
  let checkTestData44  = null;
  let checkTestData45  = null;
  let checkTestData46  = null;
  let checkTestData47  = null;
  let checkTestData48  = null;
  let checkTestData49  = null;
  let checkTestData50  = null;
  let checkTestData51  = null;
  let checkTestData52  = null;
  let checkTestData53  = null;
  let checkTestData54  = null;
  let checkTestData55  = null;
  let checkTestData56  = null;
  ...
  async function loadCheckTestData(n) {
    const map = {
      ...
      27:        { cache: () => checkTestData27, set: d => { checkTestData27 = d; }, file: 'check-test-27.json' },
      28:        { cache: () => checkTestData28, set: d => { checkTestData28 = d; }, file: 'check-test-28.json' },
      29:        { cache: () => checkTestData29, set: d => { checkTestData29 = d; }, file: 'check-test-29.json' },
      30:        { cache: () => checkTestData30, set: d => { checkTestData30 = d; }, file: 'check-test-30.json' },
      31:        { cache: () => checkTestData31, set: d => { checkTestData31 = d; }, file: 'check-test-31.json' },
      32:        { cache: () => checkTestData32, set: d => { checkTestData32 = d; }, file: 'check-test-32.json' },
      33:        { cache: () => checkTestData33, set: d => { checkTestData33 = d; }, file: 'check-test-33.json' },
      34:        { cache: () => checkTestData34, set: d => { checkTestData34 = d; }, file: 'check-test-34.json' },
      35:        { cache: () => checkTestData35, set: d => { checkTestData35 = d; }, file: 'check-test-35.json' },
      36:        { cache: () => checkTestData36, set: d => { checkTestData36 = d; }, file: 'check-test-36.json' },
      37:        { cache: () => checkTestData37, set: d => { checkTestData37 = d; }, file: 'check-test-37.json' },
      38:        { cache: () => checkTestData38, set: d => { checkTestData38 = d; }, file: 'check-test-38.json' },
      39:        { cache: () => checkTestData39, set: d => { checkTestData39 = d; }, file: 'check-test-39.json' },
      ...
      44:        { cache: () => checkTestData44, set: d => { checkTestData44 = d; }, file: 'check-test-44.json' },
      45:        { cache: () => checkTestData45, set: d => { checkTestData45 = d; }, file: 'check-test-45.json' },
      46:        { cache: () => checkTestData46, set: d => { checkTestData46 = d; }, file: 'check-test-46.json' },
      47:        { cache: () => checkTestData47, set: d => { checkTestData47 = d; }, file: 'check-test-47.json' },
      48:        { cache: () => checkTestData48, set: d => { checkTestData48 = d; }, file: 'check-test-48.json' },
      49:        { cache: () => checkTestData49, set: d => { checkTestData49 = d; }, file: 'check-test-49.json' },
      50:        { cache: () => checkTestData50, set: d => { checkTestData50 = d; }, file: 'check-test-50.json' },
      51:        { cache: () => checkTestData51, set: d => { checkTestData51 = d; }, file: 'check-test-51.json' },
      52:        { cache: () => checkTestData52, set: d => { checkTestData52 = d; }, file: 'check-test-52.json' },
      53:        { cache: () => checkTestData53, set: d => { checkTestData53 = d; }, file: 'check-test-53.json' },
      54:        { cache: () => checkTestData54, set: d => { checkTestData54 = d; }, file: 'check-test-54.json' },
      55:        { cache: () => checkTestData55, set: d => { checkTestData55 = d; }, file: 'check-test-55.json' },
      56:        { cache: () => checkTestData56, set: d => { checkTestData56 = d; }, file: 'check-test-56.json' },
    };
  ...
  function updatePortalStats() {
    ...
    const ct27El = document.getElementById('ct27-stat-history');
    if (ct27El) ct27El.textContent = `実施回数: ${CheckTest.getHistory('check-test-27').length}回`;
    const ct28El = document.getElementById('ct28-stat-history');
    if (ct28El) ct28El.textContent = `実施回数: ${CheckTest.getHistory('check-test-28').length}回`;
    const ct29El = document.getElementById('ct29-stat-history');
    if (ct29El) ct29El.textContent = `実施回数: ${CheckTest.getHistory('check-test-29').length}回`;
    const ct30El = document.getElementById('ct30-stat-history');
    if (ct30El) ct30El.textContent = `実施回数: ${CheckTest.getHistory('check-test-30').length}回`;
    const ct31El = document.getElementById('ct31-stat-history');
    if (ct31El) ct31El.textContent = `実施回数: ${CheckTest.getHistory('check-test-31').length}回`;
    const ct32El = document.getElementById('ct32-stat-history');
    if (ct32El) ct32El.textContent = `実施回数: ${CheckTest.getHistory('check-test-32').length}回`;
    const ct33El = document.getElementById('ct33-stat-history');
    if (ct33El) ct33El.textContent = `実施回数: ${CheckTest.getHistory('check-test-33').length}回`;
    const ct34El = document.getElementById('ct34-stat-history');
    if (ct34El) ct34El.textContent = `実施回数: ${CheckTest.getHistory('check-test-34').length}回`;
    const ct35El = document.getElementById('ct35-stat-history');
    if (ct35El) ct35El.textContent = `実施回数: ${CheckTest.getHistory('check-test-35').length}回`;
    const ct36El = document.getElementById('ct36-stat-history');
    if (ct36El) ct36El.textContent = `実施回数: ${CheckTest.getHistory('check-test-36').length}回`;
    const ct37El = document.getElementById('ct37-stat-history');
    if (ct37El) ct37El.textContent = `実施回数: ${CheckTest.getHistory('check-test-37').length}回`;
    const ct38El = document.getElementById('ct38-stat-history');
    if (ct38El) ct38El.textContent = `実施回数: ${CheckTest.getHistory('check-test-38').length}回`;
    const ct39El = document.getElementById('ct39-stat-history');
    if (ct39El) ct39El.textContent = `実施回数: ${CheckTest.getHistory('check-test-39').length}回`;
    const ct40El = document.getElementById('ct40-stat-history');
    if (ct40El) ct40El.textContent = `実施回数: ${CheckTest.getHistory('check-test-40').length}回`;
    const ct41El = document.getElementById('ct41-stat-history');
    ...
    const ct44El = document.getElementById('ct44-stat-history');
    if (ct44El) ct44El.textContent = `実施回数: ${CheckTest.getHistory('check-test-44').length}回`;
    const ct45El = document.getElementById('ct45-stat-history');
    if (ct45El) ct45El.textContent = `実施回数: ${CheckTest.getHistory('check-test-45').length}回`;
    const ct46El = document.getElementById('ct46-stat-history');
    if (ct46El) ct46El.textContent = `実施回数: ${CheckTest.getHistory('check-test-46').length}回`;
    const ct47El = document.getElementById('ct47-stat-history');
    if (ct47El) ct47El.textContent = `実施回数: ${CheckTest.getHistory('check-test-47').length}回`;
    const ct48El = document.getElementById('ct48-stat-history');
    if (ct48El) ct48El.textContent = `実施回数: ${CheckTest.getHistory('check-test-48').length}回`;
    const ct49El = document.getElementById('ct49-stat-history');
    if (ct49El) ct49El.textContent = `実施回数: ${CheckTest.getHistory('check-test-49').length}回`;
    const ct50El = document.getElementById('ct50-stat-history');
    if (ct50El) ct50El.textContent = `実施回数: ${CheckTest.getHistory('check-test-50').length}回`;
    const ct51El = document.getElementById('ct51-stat-history');
    if (ct51El) ct51El.textContent = `実施回数: ${CheckTest.getHistory('check-test-51').length}回`;
    const ct52El = document.getElementById('ct52-stat-history');
    if (ct52El) ct52El.textContent = `実施回数: ${CheckTest.getHistory('check-test-52').length}回`;
    const ct53El = document.getElementById('ct53-stat-history');
    if (ct53El) ct53El.textContent = `実施回数: ${CheckTest.getHistory('check-test-53').length}回`;
    const ct54El = document.getElementById('ct54-stat-history');
    if (ct54El) ct54El.textContent = `実施回数: ${CheckTest.getHistory('check-test-54').length}回`;
    const ct55El = document.getElementById('ct55-stat-history');
    if (ct55El) ct55El.textContent = `実施回数: ${CheckTest.getHistory('check-test-55').length}回`;
    const ct56El = document.getElementById('ct56-stat-history');
    if (ct56El) ct56El.textContent = `実施回数: ${CheckTest.getHistory('check-test-56').length}回`;
  }
  ...
  async function init() {
    ...
    document.getElementById('card-check-test-27').addEventListener('click', () => goCheckTest(27));
    document.getElementById('card-check-test-28').addEventListener('click', () => goCheckTest(28));
    document.getElementById('card-check-test-29').addEventListener('click', () => goCheckTest(29));
    document.getElementById('card-check-test-30').addEventListener('click', () => goCheckTest(30));
    document.getElementById('card-check-test-31').addEventListener('click', () => goCheckTest(31));
    document.getElementById('card-check-test-32').addEventListener('click', () => goCheckTest(32));
    document.getElementById('card-check-test-33').addEventListener('click', () => goCheckTest(33));
    document.getElementById('card-check-test-34').addEventListener('click', () => goCheckTest(34));
    document.getElementById('card-check-test-35').addEventListener('click', () => goCheckTest(35));
    document.getElementById('card-check-test-36').addEventListener('click', () => goCheckTest(36));
    document.getElementById('card-check-test-37').addEventListener('click', () => goCheckTest(37));
    document.getElementById('card-check-test-38').addEventListener('click', () => goCheckTest(38));
    document.getElementById('card-check-test-39').addEventListener('click', () => goCheckTest(39));
    ...
    document.getElementById('card-check-test-44').addEventListener('click', () => goCheckTest(44));
    document.getElementById('card-check-test-45').addEventListener('click', () => goCheckTest(45));
    document.getElementById('card-check-test-46').addEventListener('click', () => goCheckTest(46));
    document.getElementById('card-check-test-47').addEventListener('click', () => goCheckTest(47));
    document.getElementById('card-check-test-48').addEventListener('click', () => goCheckTest(48));
    document.getElementById('card-check-test-49').addEventListener('click', () => goCheckTest(49));
    document.getElementById('card-check-test-50').addEventListener('click', () => goCheckTest(50));
    document.getElementById('card-check-test-51').addEventListener('click', () => goCheckTest(51));
    document.getElementById('card-check-test-52').addEventListener('click', () => goCheckTest(52));
    document.getElementById('card-check-test-53').addEventListener('click', () => goCheckTest(53));
    document.getElementById('card-check-test-54').addEventListener('click', () => goCheckTest(54));
    document.getElementById('card-check-test-55').addEventListener('click', () => goCheckTest(55));
    document.getElementById('card-check-test-56').addEventListener('click', () => goCheckTest(56));
