...
const CheckTest = (() => {
  ...
  const CONFIGS = {
    ...
    'check-test-takenaka': { id: 'check-test-takenaka', title: 'まどかさん用確認テスト', historyKey: 'ccna_check_test_takenaka_history', hasDnd: true, hasSimulation: true, shuffleDnd: true, passRequiresDndPerfect: true, passRequiresSimPerfect: true },
    ...
    'check-test-33': { id: 'check-test-33', title: '確認テスト33回目', historyKey: 'ccna_check_test_33_history', hasDnd: true,  hasSimulation: true },
    'check-test-34': { id: 'check-test-34', title: '確認テスト34回目', historyKey: 'ccna_check_test_34_history', hasDnd: true,  hasSimulation: false },
    'check-test-35': { id: 'check-test-35', title: '確認テスト35回目', historyKey: 'ccna_check_test_35_history', hasDnd: true,  hasSimulation: false },
    'check-test-36': { id: 'check-test-36', title: '確認テスト36回目', historyKey: 'ccna_check_test_36_history', hasDnd: true,  hasSimulation: false },
    'check-test-37': { id: 'check-test-37', title: '確認テスト37回目', historyKey: 'ccna_check_test_37_history', hasDnd: true,  hasSimulation: false },
    'check-test-38': { id: 'check-test-38', title: '確認テスト38回目', historyKey: 'ccna_check_test_38_history', hasDnd: true,  hasSimulation: false },
    'check-test-39': { id: 'check-test-39', title: '確認テスト39回目', historyKey: 'ccna_check_test_39_history', hasDnd: true,  hasSimulation: false },
    'check-test-40': { id: 'check-test-40', title: '確認テスト40回目', historyKey: 'ccna_check_test_40_history', hasDnd: true,  hasSimulation: false },
    'check-test-41': { id: 'check-test-41', title: '確認テスト41回目', historyKey: 'ccna_check_test_41_history', hasDnd: true,  hasSimulation: true },
    'check-test-42': { id: 'check-test-42', title: '確認テスト42回目', historyKey: 'ccna_check_test_42_history', hasDnd: true,  hasSimulation: true },
    'check-test-43': { id: 'check-test-43', title: '確認テスト43回目', historyKey: 'ccna_check_test_43_history', hasDnd: true,  hasSimulation: true },
    'check-test-44': { id: 'check-test-44', title: '確認テスト44回目', historyKey: 'ccna_check_test_44_history', hasDnd: true,  hasSimulation: true },
    'check-test-45': { id: 'check-test-45', title: '確認テスト45回目', historyKey: 'ccna_check_test_45_history', hasDnd: true,  hasSimulation: true },
    'check-test-46': { id: 'check-test-46', title: '確認テスト46回目', historyKey: 'ccna_check_test_46_history', hasDnd: true,  hasSimulation: true },
    'check-test-47': { id: 'check-test-47', title: '確認テスト47回目', historyKey: 'ccna_check_test_47_history', hasDnd: true,  hasSimulation: true },
    'check-test-48': { id: 'check-test-48', title: '確認テスト48回目', historyKey: 'ccna_check_test_48_history', hasDnd: true,  hasSimulation: true },
    'check-test-49': { id: 'check-test-49', title: '確認テスト49回目', historyKey: 'ccna_check_test_49_history', hasDnd: true,  hasSimulation: true },
    'check-test-50': { id: 'check-test-50', title: '確認テスト50回目', historyKey: 'ccna_check_test_50_history', hasDnd: true,  hasSimulation: true },
    'check-test-51': { id: 'check-test-51', title: '確認テスト51回目', historyKey: 'ccna_check_test_51_history', hasDnd: true,  hasSimulation: true },
    'check-test-52': { id: 'check-test-52', title: '確認テスト52回目', historyKey: 'ccna_check_test_52_history', hasDnd: true,  hasSimulation: true },
    'check-test-53': { id: 'check-test-53', title: '確認テスト53回目', historyKey: 'ccna_check_test_53_history', hasDnd: true,  hasSimulation: true },
    'check-test-54': { id: 'check-test-54', title: '確認テスト54回目', historyKey: 'ccna_check_test_54_history', hasDnd: true,  hasSimulation: true },
    'check-test-55': { id: 'check-test-55', title: '確認テスト55回目', historyKey: 'ccna_check_test_55_history', hasDnd: true,  hasSimulation: true },
    'check-test-56': { id: 'check-test-56', title: '確認テスト56回目', historyKey: 'ccna_check_test_56_history', hasDnd: true,  hasSimulation: true },
  };
