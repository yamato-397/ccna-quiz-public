...
const SEED = 'madoka-check-test-2026-09-20';
...
const output = {
  ...
  title: 'まどかさん用確認テスト',
  description: 'Part⑥・Part⑦からランダム抽出した固定100問 + D&D全28問(出題順ランダム)',
  questionCount: 100,
  passingScore: 95,
  questions,
...
console.log(`Updated ${path.relative(ROOT, OUTPUT_PATH)}: Part⑥ ${part6}問 / Part⑦ ${part7}問 / D&D 28問 / シミュレーション 0問`);
